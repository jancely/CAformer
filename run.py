...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='CAformer')

    # Fractional
    parser.add_argument('--order', type=float, default=0.5, help='fractional order for causality')

    # GCN
    parser.add_argument('--node_dim', type=int, default=10, help='each node embed to dim dimentions')
    ...
    parser.add_argument('--test_flop', type=int, default=0, help='flop; True 1 False 0')
